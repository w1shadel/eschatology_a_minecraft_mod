...
public class VoidLanceRenderer extends EntityRenderer<VoidLanceEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Eschatology.MODID, "textures/entity/void_lance.png");
    private final VoidLanceModel model;

    public VoidLanceRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
