...
public class BlackBoolMoveControl extends FlyingMoveControl {
    private final BlackBool boss;

    public BlackBoolMoveControl(Monster pMob, int pMaxTurn, boolean pHoversInPlace) {
