...
public class VoidWaveRenderer extends EntityRenderer<VoidWaveEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Eschatology.MODID, "textures/entity/void_wave.png");
    private final VoidWaveModel<VoidWaveEntity> model;

    public VoidWaveRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
