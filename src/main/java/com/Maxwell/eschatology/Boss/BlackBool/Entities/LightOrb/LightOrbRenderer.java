...
public class LightOrbRenderer extends EntityRenderer<LightOrbEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Eschatology.MODID, "textures/entity/light_orb.png");
    private final LightOrbModel<LightOrbEntity> model;
