package com.Maxwell.eschatology.Boss.BlackBool.Entities.VoidLance;
...
public class VoidLanceModel<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "voidlancemodel"), "main");
    private final ModelPart root;

    public VoidLanceModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition root = partdefinition.addOrReplaceChild("root", CubeListBuilder.create().texOffs(8, 32).addBox(4.0F, -16.0F, 3.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(32, 0).addBox(-6.0F, -16.0F, 3.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, -4.0F));
