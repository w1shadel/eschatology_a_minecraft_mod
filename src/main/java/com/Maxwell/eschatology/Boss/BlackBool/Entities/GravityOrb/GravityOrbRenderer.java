...
public class GravityOrbRenderer extends EntityRenderer<GravityOrbEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Eschatology.MODID, "textures/entity/gravity_orb.png");
    private final GravityOrbModel model;

    public GravityOrbRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
