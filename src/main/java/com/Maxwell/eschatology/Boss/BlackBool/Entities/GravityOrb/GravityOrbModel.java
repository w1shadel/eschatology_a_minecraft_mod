...
public class GravityOrbModel extends HierarchicalModel<GravityOrbEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Eschatology.MODID, "gravity_orb"), "main");
    private final ModelPart bb_main;

    public GravityOrbModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 36).addBox(-3.0F, -9.0F, -1.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(24, 24).addBox(-5.0F, -15.0F, -1.0F, 10.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
