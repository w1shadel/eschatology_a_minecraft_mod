...
public class VoidLanceEntity extends Projectile {
    ...
    private boolean hasSearchedTarget = false;

    public VoidLanceEntity(EntityType<? extends VoidLanceEntity> pEntityType, Level pLevel) {
