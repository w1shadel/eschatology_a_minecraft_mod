package com.Maxwell.eschatology.Boss.BlackBool.Entities.EndLaser;import com.mojang.blaze3d.vertex.PoseStack;
...
public class EndLaserBeamRenderer extends EntityRenderer<EndLaserBeamEntity> {    private static final ResourceLocation BEAM_TEXTURE = new ResourceLocation("eschatology", "textures/entity/end_laser_beam.png");
    ...
    public ResourceLocation getTextureLocation(EndLaserBeamEntity pEntity) {
        return BEAM_TEXTURE;
    }    @Override
    public void render(EndLaserBeamEntity pEntity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        Vec3 startPos = pEntity.getPosition(pPartialTick);
        Vec3 endPos = pEntity.getEndPos();        float length = (float) startPos.distanceTo(endPos);
        ...
        Matrix3f matrix3f = poseStack.last().normal();        float vScroll = -time * 0.02f * textureScrollSpeed;        addVertex(matrix4f, matrix3f, consumer, 0, -radius, 0, 0, 0 + vScroll, r, g, b, a);
        ...
        addVertex(matrix4f, matrix3f, consumer, 0, radius, 0, 0, 1 + vScroll, r, g, b, a);        addVertex(matrix4f, matrix3f, consumer, -radius, 0, 0, 0, 0 + vScroll, r, g, b, a);
