...
public class EndLaserBeamRenderer extends EntityRenderer<EndLaserBeamEntity> {
    private static final ResourceLocation BEAM_TEXTURE = new ResourceLocation("eschatology", "textures/entity/end_laser_beam.png");
    ...
    public EndLaserBeamRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
