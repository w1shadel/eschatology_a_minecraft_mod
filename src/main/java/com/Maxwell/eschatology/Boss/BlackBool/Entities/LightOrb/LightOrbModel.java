...
public class LightOrbModel<T extends Entity> extends EntityModel<T> {	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Eschatology.MODID, "light_orb"), "main");
	private final ModelPart bb_main;	public LightOrbModel(ModelPart root) {
