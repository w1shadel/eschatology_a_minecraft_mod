...
public class SimpleLaserAttackGoal extends Goal {
    ...
    public SimpleLaserAttackGoal(ExoWither owner, int cooldown) {
        this.owner = owner;
    ...
    public void tick() {
        ...
        this.attackTime++;
        if (this.attackTime >= this.startFireTick && this.attackTime <= this.endFireTick) {
