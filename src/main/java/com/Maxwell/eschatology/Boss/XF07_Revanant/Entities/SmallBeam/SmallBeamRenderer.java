...
public class SmallBeamRenderer extends EntityRenderer<SmallBeamEntity> {
    ...
    public SmallBeamRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public void render(SmallBeamEntity entity, float entityYaw, float partialTicks,
        ...
        float beamLength = 0.8F;
        float beamWidth = 0.15F;
        poseStack.scale(beamLength, beamLength, beamLength);
        VertexConsumer vertexConsumer = buffer.getBuffer(RENDER_TYPE);
        PoseStack.Pose pose = poseStack.last();
        Matrix4f matrix4f = pose.pose();
        Matrix3f matrix3f = pose.normal();
        drawQuad(vertexConsumer, matrix4f, matrix3f, packedLight, beamWidth);
        ...
        drawQuad(vertexConsumer, matrix4f2, matrix3f2, packedLight, beamWidth);
        poseStack.popPose();
