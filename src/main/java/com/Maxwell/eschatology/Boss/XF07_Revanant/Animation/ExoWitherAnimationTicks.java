package com.Maxwell.eschatology.Boss.XF07_Revanant.Animation;public class ExoWitherAnimationTicks {    public static final float SPAWN_LENGTH_IN_SECONDS = 4.5F;
    ...
    public static final float SIMPLE_LASER_ATTACK_LENGTH_IN_SECONDS = 1.25F;
    public static final float MISSILE_SHOOT_ATTACK_LENGTH_IN_SECONDS = 3.0833F;
    public static final float LASERBEAM_ATTACK_LENGTH_IN_SECONDS = 8.0F;
    public static final float DEATH_LENGTH_IN_SECONDS = 89.0F;
}