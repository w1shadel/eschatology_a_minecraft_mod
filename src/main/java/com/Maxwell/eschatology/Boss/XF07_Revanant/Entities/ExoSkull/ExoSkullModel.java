...
public class ExoSkullModel extends HierarchicalModel<ExoSkull> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "exoskullmodel"), "main");
    private final ModelPart bb_main;

    public ExoSkullModel(ModelPart root) {
