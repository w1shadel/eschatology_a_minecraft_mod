...
public class ExoWitherAnimation {
    public static final AnimationDefinition SPAWN = AnimationDefinition.Builder.withLength(4.5F)
            ...
            .build();
    public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(2.25F)
            ...
            .build();
    public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(3.375F)
            ...
            .build();
    public static final AnimationDefinition CHARGE_ATTACK = AnimationDefinition.Builder.withLength(3.125F)
            .addAnimation("left_booster", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .build();
    public static final AnimationDefinition SIMPLE_LASER_ATTACK = AnimationDefinition.Builder.withLength(1.25F)
            .addAnimation("face_left", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .build();
    public static final AnimationDefinition MISSILE_SHOOT_ATTACK = AnimationDefinition.Builder.withLength(3.0833F)
            .addAnimation("left_booster", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .build();
    public static final AnimationDefinition LASERBEAM_ATTACK = AnimationDefinition.Builder.withLength(8.0F)
            .addAnimation("left_booster", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .build();
    public static final AnimationDefinition DEATH = AnimationDefinition.Builder.withLength(89.0F)
            .addAnimation("face_front", new AnimationChannel(AnimationChannel.Targets.SCALE,
