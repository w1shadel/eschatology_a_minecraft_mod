...
public class ExoMissileRenderer extends EntityRenderer<ExoMissile> {
    private static final ResourceLocation TEXTURE_LOCATION =
            new ResourceLocation(Eschatology.MODID, "textures/entity/exo_missile.png");
    private final ExoMissileModel model;

    public ExoMissileRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    ...
    public void render(ExoMissile entity, float entityYaw, float partialTicks,
        ...
        if (velocity.lengthSqr() > 1.0E-6) {
            ...
            float pitch = (float) (Mth.atan2(velocity.y, velocity.horizontalDistance()) * (180F / Math.PI));
