package com.Maxwell.eschatology.Config.Boss;import com.Maxwell.eschatology.Balance.ExoWitherBalance;
...
public class ExoWitherConfigSync {    @SubscribeEvent
    public static void onModConfigEvent(ModConfigEvent event) {
        if (event.getConfig().getSpec() == ExoWitherConfig.SPEC) {
            bakeConfig();
        }
    }    private static void bakeConfig() {        ExoWitherBalance.MAX_HEALTH = ExoWitherConfig.MAX_HEALTH.get();
        ...
        ExoWitherBalance.EXO_SKULL_ATTACK_COOLDOWN = ExoWitherConfig.EXO_SKULL_ATTACK_COOLDOWN.get();        ExoWitherBalance.SHIELD_INITIAL_HEALTH = ExoWitherConfig.SHIELD_INITIAL_HEALTH.get();
        ExoWitherBalance.SHIELD_DEPLOY_HP_THRESHOLD = ExoWitherConfig.SHIELD_DEPLOY_HP_THRESHOLD.get();
        ExoWitherBalance.ENRAGE_HP_THRESHOLD = ExoWitherConfig.ENRAGE_HP_THRESHOLD.get();        ExoWitherBalance.PROJECTILE_SPEED = ExoWitherConfig.PROJECTILE_SPEED.get();
        ...
        ExoWitherBalance.Y_CLAMP = ExoWitherConfig.Y_CLAMP.get();        ExoWitherBalance.PASSIVE_ATTACK_INTERVAL_TICKS = ExoWitherConfig.PASSIVE_ATTACK_INTERVAL_TICKS.get();
        ...
        ExoWitherBalance.PASSIVE_SKULL_SPAWN_CHANCE = ExoWitherConfig.PASSIVE_SKULL_SPAWN_CHANCE.get().floatValue();        ExoWitherBalance.CHARGE_PREPARE_DURATION_TICKS = ExoWitherConfig.CHARGE_PREPARE_DURATION_TICKS.get();
    ...
    ExoWitherBalance.MISSILE_MIN_DIST_SQ = ExoWitherConfig.MISSILE_MIN_DIST_SQ.get();
        ...
        ExoWitherBalance.MISSILE_INITIAL_VERTICAL_SPEED = ExoWitherConfig.MISSILE_INITIAL_VERTICAL_SPEED.get();        ExoWitherBalance.MORTAR_MIN_DIST_SQ = ExoWitherConfig.MORTAR_MIN_DIST_SQ.get();
        ...
        ExoWitherBalance.MORTAR_DAMAGE_RATIO = ExoWitherConfig.MORTAR_DAMAGE_RATIO.get().floatValue();        ExoWitherBalance.SIMPLE_LASER_START_TICK_NORMAL = ExoWitherConfig.SIMPLE_LASER_START_TICK_NORMAL.get();
        ...
        ExoWitherBalance.SIMPLE_LASER_FIRE_INTERVAL_ENRAGED = ExoWitherConfig.SIMPLE_LASER_FIRE_INTERVAL_ENRAGED.get();        ExoWitherBalance.EXO_MISSILE_BASE_DAMAGE = ExoWitherConfig.EXO_MISSILE_BASE_DAMAGE.get().floatValue();
        ...
        ExoWitherBalance.EXO_MISSILE_FREEZING_STRIKE_DURATION = ExoWitherConfig.EXO_MISSILE_FREEZING_STRIKE_DURATION.get();        ExoWitherBalance.EXO_SKULL_DIRECT_DAMAGE = ExoWitherConfig.EXO_SKULL_DIRECT_DAMAGE.get().floatValue();
        ...
        ExoWitherBalance.EXO_SKULL_FREEZING_STRIKE_AMPLIFIER_EXPLOSION = ExoWitherConfig.EXO_SKULL_FREEZING_STRIKE_AMPLIFIER_EXPLOSION.get();        ExoWitherBalance.FROST_FIELD_DURATION = ExoWitherConfig.FROST_FIELD_DURATION.get();
        ...
        ExoWitherBalance.FROST_FIELD_EFFECT_MAX_AMPLIFIER = ExoWitherConfig.FROST_FIELD_EFFECT_MAX_AMPLIFIER.get();        ExoWitherBalance.SMALL_BEAM_BASE_DAMAGE = ExoWitherConfig.SMALL_BEAM_BASE_DAMAGE.get().floatValue();
        ...
        ExoWitherBalance.SMALL_BEAM_EFFECT_AMPLIFIER_ENRAGED = ExoWitherConfig.SMALL_BEAM_EFFECT_AMPLIFIER_ENRAGED.get();        ExoWitherBalance.FROZEN_EXOHEART_PERCENT = ExoWitherConfig.FROZEN_EXOHEART_PERCENT.get().floatValue();
    }
}