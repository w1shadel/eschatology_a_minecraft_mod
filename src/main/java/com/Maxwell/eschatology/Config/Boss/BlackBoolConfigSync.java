...
public class BlackBoolConfigSync {
    ...
    private static void bakeConfig() {
        ...
        BlackBoolBalance.MAX_HEALTH = BlackBoolConfig.MAX_HEALTH.get();
        ...
        BlackBoolBalance.ARMOR = BlackBoolConfig.ARMOR.get();

        BlackBoolBalance.CONTACT_DAMAGE_RATIO = BlackBoolConfig.CONTACT_DAMAGE_RATIO.get().floatValue();

        BlackBoolBalance.SPAWN_ANIMATION_DURATION_TICKS = BlackBoolConfig.SPAWN_ANIMATION_DURATION_TICKS.get();
        ...
        BlackBoolBalance.DEATH_PHASE4_FINAL_TICKS = BlackBoolConfig.DEATH_PHASE4_FINAL_TICKS.get();

        BlackBoolBalance.DEATH_PULL_AREA_RADIUS = BlackBoolConfig.DEATH_PULL_AREA_RADIUS.get();
        BlackBoolBalance.DEATH_PULL_STRENGTH = BlackBoolConfig.DEATH_PULL_STRENGTH.get().floatValue();

        BlackBoolBalance.STANCE_SWITCH_MELEE_RANGE_SQ = BlackBoolConfig.STANCE_SWITCH_MELEE_RANGE_SQ.get();
        ...
        BlackBoolBalance.RANDOM_FLY_RADIUS = BlackBoolConfig.RANDOM_FLY_RADIUS.get();

        BlackBoolBalance.PHASE_TWO_HP_THRESHOLD = BlackBoolConfig.PHASE_TWO_HP_THRESHOLD.get().floatValue();
        BlackBoolBalance.CRITICAL_ENRAGE_HP_THRESHOLD = BlackBoolConfig.CRITICAL_ENRAGE_HP_THRESHOLD.get().floatValue();
        BlackBoolBalance.LANCE_SPAWN_START_HP_THRESHOLD = BlackBoolConfig.LANCE_SPAWN_START_HP_THRESHOLD.get().floatValue();

        BlackBoolBalance.CHARGE_COOLDOWN_BASE = BlackBoolConfig.CHARGE_COOLDOWN_BASE.get();
        ...
        BlackBoolBalance.PASSIVE_ORB_COOLDOWN_BASE = BlackBoolConfig.PASSIVE_ORB_COOLDOWN_BASE.get();

        BlackBoolBalance.MAX_ORBITING_PROJECTILES = BlackBoolConfig.MAX_ORBITING_PROJECTILES.get();
        ...
        BlackBoolBalance.DAMAGE_CAP_REDUCTION_RATIO = BlackBoolConfig.DAMAGE_CAP_REDUCTION_RATIO.get().floatValue();

        BlackBoolBalance.CHARGE_MIN_DISTANCE_SQ = BlackBoolConfig.CHARGE_MIN_DISTANCE_SQ.get();
        ...
        BlackBoolBalance.CHARGE_COUNT_ENRAGED = BlackBoolConfig.CHARGE_COUNT_ENRAGED.get();

        BlackBoolBalance.GRAVITY_ORB_MIN_DISTANCE_SQ = BlackBoolConfig.GRAVITY_ORB_MIN_DISTANCE_SQ.get();
        ...
        BlackBoolBalance.BARRAGE_FIRE_RATE_ENRAGED = BlackBoolConfig.BARRAGE_FIRE_RATE_ENRAGED.get();

        BlackBoolBalance.LASER_HP_THRESHOLD = BlackBoolConfig.LASER_HP_THRESHOLD.get().floatValue();
        ...
        BlackBoolBalance.LASER_FIELD_HP_THRESHOLD = BlackBoolConfig.LASER_FIELD_HP_THRESHOLD.get().floatValue();

        BlackBoolBalance.EVENT_HORIZON_HP_THRESHOLD = BlackBoolConfig.EVENT_HORIZON_HP_THRESHOLD.get().floatValue();
