...
import com.Maxwell.eschatology.common.helper.AnimationPlayHelper;
...
public class StartAnimationPacket implements IClientboundPacket {
    private final UUID playerUUID;
    private final String animationName;
    private final boolean shouldDamage;
    private final boolean lockMovement;

    public StartAnimationPacket(UUID playerUUID, String animationName, boolean shouldDamage, boolean lockMovement) {
    ...
    public void handle(NetworkEvent.Context context) {
        ...
        Player targetPlayer = level.getPlayerByUUID(this.playerUUID);
