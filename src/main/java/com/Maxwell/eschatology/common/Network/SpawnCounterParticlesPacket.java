...
import com.Maxwell.eschatology.client.ClientPacketHandler;
import net.minecraft.network.FriendlyByteBuf;
import net.minecraft.world.phys.Vec3;
import net.minecraftforge.network.NetworkEvent;

public class SpawnCounterParticlesPacket implements IClientboundPacket {
    private final Vec3 position;

    public SpawnCounterParticlesPacket(Vec3 position) {
