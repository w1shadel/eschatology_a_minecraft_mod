package com.Maxwell.eschatology.common.Network;import com.Maxwell.eschatology.client.GUI.Glitch.GlitchyGuiManager;
import net.minecraft.network.FriendlyByteBuf;
import net.minecraftforge.api.distmarker.Dist;
import net.minecraftforge.api.distmarker.OnlyIn;
import net.minecraftforge.network.NetworkEvent;
public class SyncGlitchEffectPacket implements IClientboundPacket {
    private final float intensity;    public SyncGlitchEffectPacket(float intensity) {
