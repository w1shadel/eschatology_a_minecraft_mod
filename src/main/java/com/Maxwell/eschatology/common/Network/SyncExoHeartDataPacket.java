package com.Maxwell.eschatology.common.Network;import com.Maxwell.eschatology.client.ExoHeart.ExoHeartHudOverlay;
...
public class SyncExoHeartDataPacket implements IClientboundPacket {
    ...
    private final boolean active;    public SyncExoHeartDataPacket(int charge, boolean active) {
        this.charge = charge;
        this.active = active;
