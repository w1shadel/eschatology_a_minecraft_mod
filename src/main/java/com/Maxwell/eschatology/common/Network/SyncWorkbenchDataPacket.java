...
import net.minecraftforge.network.NetworkEvent;public class SyncWorkbenchDataPacket implements IClientboundPacket {
    private final BlockPos pos;
    private final int ticks;
    private final boolean animating;
    private final ItemStack leftStack;
    private final ItemStack rightStack;    public SyncWorkbenchDataPacket(BlockPos pos, int ticks, boolean animating, ItemStack leftStack, ItemStack rightStack) {
        this.pos = pos;
        this.ticks = ticks;
