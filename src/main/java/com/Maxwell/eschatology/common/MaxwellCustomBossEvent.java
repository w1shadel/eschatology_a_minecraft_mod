...
public class MaxwellCustomBossEvent extends ServerBossEvent {
    private int renderId;

    public MaxwellCustomBossEvent(Component name, BossEvent.BossBarColor color, BossEvent.BossBarOverlay overlay, int renderId) {
