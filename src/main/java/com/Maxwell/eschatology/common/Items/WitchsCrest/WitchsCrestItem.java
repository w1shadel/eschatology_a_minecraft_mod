...
public class WitchsCrestItem extends SwordItem {
    public WitchsCrestItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
