...
public class Eclipse_Forge_Model<T extends Entity> extends EntityModel<T> {
    ...
    public final ModelPart table;    public Eclipse_Forge_Model(ModelPart root) {
        ...
        PartDefinition black_hoal = root.addOrReplaceChild("black_hoal", CubeListBuilder.create().texOffs(24, 61).addBox(-2.0F, -2.0625F, -4.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 40).addBox(-7.0F, -0.0625F, -7.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -13.8375F, 0.0F));
