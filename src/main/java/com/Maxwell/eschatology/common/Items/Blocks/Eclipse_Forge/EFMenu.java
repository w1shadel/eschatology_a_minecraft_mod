...
import net.minecraftforge.items.SlotItemHandler;public class EFMenu extends AbstractContainerMenu {
    ...
    public EFMenu(int id, Inventory playerInv, FriendlyByteBuf extraData) {
        ...
        this.blockEntity = entity;        this.data = new ContainerData() {
            @Override
        ...
        };        this.addDataSlots(data);        IItemHandler handler = entity.getItemHandler();
        ...
        this.addSlot(new SlotItemHandler(handler, EFBlockEntity.SLOT_CENTER, 80, 33));        addPlayerInventory(playerInv);
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            itemstack = stack.copy();            if (index < 3) {
    ...
    public void broadcastChanges() {
        ...
        if (this.blockEntity != null && this.blockEntity.getLevel() != null) {            if (!this.blockEntity.getLevel().isClientSide) {
                this.data.set(1, this.blockEntity.getAnimationTicks());
            }
        }
    }
    public boolean isAnimating() { return data.get(0) == 1; }
    public int getAnimationTicks() { return data.get(1); }
}