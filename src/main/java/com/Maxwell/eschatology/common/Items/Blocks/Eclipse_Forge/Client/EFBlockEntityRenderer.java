...
public class EFBlockEntityRenderer implements BlockEntityRenderer<EFBlockEntity> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Eschatology.MODID, "textures/entity/eclipse_forge_entity.png");
    private final Eclipse_Forge_Model<?> model;

    public EFBlockEntityRenderer(BlockEntityRendererProvider.Context ctx) {
    ...
    public void render(EFBlockEntity be, float partialTick, PoseStack poseStack,
        ...
        if (!left.isEmpty() || !right.isEmpty()) {
            ...
            double angleRight = ticks * speed + Math.PI;
            if (!left.isEmpty()) {
