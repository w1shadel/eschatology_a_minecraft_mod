...
public class EFItemStackRenderer extends BlockEntityWithoutLevelRenderer {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Eschatology.MODID, "textures/entity/eclipse_forge_entity.png");

    private Eclipse_Forge_Model<?> model;

    public EFItemStackRenderer() {
        super(null, null);
    }
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext context,
        ...
        baked.getTransforms().getTransform(context).apply(false, poseStack);
        ...
        model.renderToBuffer(poseStack, vc, packedLight, packedOverlay, 1, 1, 1, 1);
