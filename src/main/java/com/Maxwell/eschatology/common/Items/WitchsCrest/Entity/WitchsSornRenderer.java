...
public class WitchsSornRenderer extends EntityRenderer<WitchsSorn> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Eschatology.MODID, "textures/entity/witch_sorn.png");
    private final WitchsSornModel model;

    public WitchsSornRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
