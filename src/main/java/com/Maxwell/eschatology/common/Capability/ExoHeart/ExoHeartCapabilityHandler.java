package com.Maxwell.eschatology.common.Capability.ExoHeart;
...
public class ExoHeartCapabilityHandler {
    public static final ResourceLocation ID = new ResourceLocation(Eschatology.MODID, "exoheart");
    ...
    public static class Provider implements ICapabilityProvider, ICapabilitySerializable<CompoundTag> {
        private final ExoHeartData data = new ExoHeartData();
        private final LazyOptional<ExoHeartData> optional = LazyOptional.of(() -> data);
