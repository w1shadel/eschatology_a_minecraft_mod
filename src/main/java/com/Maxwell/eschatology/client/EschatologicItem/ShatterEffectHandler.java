...
public class ShatterEffectHandler {
    private static final ResourceLocation SHATTER_TEXTURE = new ResourceLocation(Eschatology.MODID, "textures/gui/shatter_overlay.png");
