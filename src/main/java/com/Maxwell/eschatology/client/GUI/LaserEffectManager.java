package com.Maxwell.eschatology.client.GUI;
...
public class LaserEffectManager {
    ...
    public static void handleLaserEffect(SyncLaserEffectsPacket.EffectPhase phase) {
