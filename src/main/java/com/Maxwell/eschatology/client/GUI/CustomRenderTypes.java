...
public class CustomRenderTypes extends RenderType {    private CustomRenderTypes(String pName, VertexFormat pFormat, VertexFormat.Mode pMode, int pBufferSize, boolean pAffectsCrumbling, boolean pSortOnUpload, Runnable pSetupState, Runnable pClearState) {
    ...
    public static final RenderType NEBULA_TYPE = RenderType.create(
            ...
            true,
            true,
            RenderType.CompositeState.builder()                    .setShaderState(RENDERTYPE_ENTITY_TRANSLUCENT_SHADER)                    .setTextureState(new TextureStateShard(WALL_TEXTURE, false, true))
