...
@Mod.EventBusSubscriber(modid = Eschatology.MODID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ExoHeartKeybind {
    public static final String CATEGORY = "key.categories.eschatology";
    public static final String KEY_NAME = "key.eschatology.activate_exoheart";
    public static KeyMapping ACTIVATE_EXOHEART;
