...
public class BlackBoolBalance {    public static double MAX_HEALTH = 550.0;
    ...
    public static float CONTACT_DAMAGE_RATIO = 0.4f;    public static int SPAWN_ANIMATION_DURATION_TICKS = 60;
    ...
    public static float DEATH_PULL_STRENGTH = 0.4f;    public static double STANCE_SWITCH_MELEE_RANGE_SQ = 100.0;
    ...
    public static double RANDOM_FLY_RADIUS = 16.0;    public static float PHASE_TWO_HP_THRESHOLD = 0.5f;
    public static float CRITICAL_ENRAGE_HP_THRESHOLD = 0.25f;
    public static float LANCE_SPAWN_START_HP_THRESHOLD = 0.75f;    public static int CHARGE_COOLDOWN_BASE = 100;
    ...
    public static int PASSIVE_ORB_COOLDOWN_BASE = 80;    public static int MAX_ORBITING_PROJECTILES = 8;
    public static double PROJECTILE_CAPTURE_RADIUS = 10.0;
    public static float DAMAGE_CAP_PER_TICK = 25.0f;
    public static float DAMAGE_CAP_REDUCTION_RATIO = 0.2f;    public static double CHARGE_MIN_DISTANCE_SQ = 16.0;
    ...
    public static int CHARGE_COUNT_ENRAGED = 3;    public static double GRAVITY_ORB_MIN_DISTANCE_SQ = 144.0;
    public static int GRAVITY_ORB_CHARGE_UP_TICKS = 25;    public static double BARRAGE_MIN_DISTANCE_SQ = 225.0;
    ...
    public static int BARRAGE_FIRE_RATE_ENRAGED = 4;    public static float LASER_HP_THRESHOLD = 0.5f;
    ...
    public static float LASER_FIELD_HP_THRESHOLD = 0.3f;    public static float EVENT_HORIZON_HP_THRESHOLD = 0.5f;
