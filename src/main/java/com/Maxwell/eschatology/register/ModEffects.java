...
public class ModEffects {
    public static final DeferredRegister<MobEffect> MOB_EFFECTS =
            DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, Eschatology.MODID);
    public static final RegistryObject<MobEffect> GRAVITY_BOUND = MOB_EFFECTS.register("gravity_bound",
    ...
    public static final RegistryObject<MobEffect> SELF_CONTEMPT = MOB_EFFECTS.register("self_contempt",
            SelfContemptEffect::new);
    public static final RegistryObject<MobEffect> COUNTER_STANCE = MOB_EFFECTS.register("counter_stance",
            CounterStanceEffect::new);
    public static final RegistryObject<MobEffect> FREEZING_STRIKE = MOB_EFFECTS.register("freezing_strike",
