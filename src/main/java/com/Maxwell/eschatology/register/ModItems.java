...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(Registries.ITEM, Eschatology.MODID);

    public static final RegistryObject<Item> DEMOND = ITEMS.register("demond", () -> new Item(new Item.Properties().rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<Item> ENTITY_REMOVER = ITEMS.register("haetataki", () -> new EntityRemove(new Item.Properties().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> BLACK_BOOL_SPAWN_EGG = ITEMS.register("black_bool_spawn_egg",
