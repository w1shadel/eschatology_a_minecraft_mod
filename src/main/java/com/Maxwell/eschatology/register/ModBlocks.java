...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, Eschatology.MODID);    public static final RegistryObject<Block> ALTAR_OF_THE_ECLIPSE =
            registerBlock("altar_of_the_eclipse", AltarOfTheEclipseBlock::new);    public static final RegistryObject<Block> FROZEN_EXO_WITHER =
            registerBlock("frozen_exo_wither", FrozenExoBlock::new);    public static final RegistryObject<Block> ECLIPSE_FORGE =
            BLOCKS.register("eclipse_forge",
                    () -> new EFBlock(BlockBehaviour.Properties.of().strength(2.5f)));    static {        ModItems.ITEMS.register("eclipse_forge",
