package com.Maxwell.eschatology.register.advancements;
...
public class KillExoWitherTrigger extends SimpleCriterionTrigger<KillExoWitherTrigger.TriggerInstance> {
    static final ResourceLocation ID = new ResourceLocation(Eschatology.MODID, "kill_exo_wither");
