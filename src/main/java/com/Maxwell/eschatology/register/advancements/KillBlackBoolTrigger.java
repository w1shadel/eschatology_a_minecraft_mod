...
public class KillBlackBoolTrigger extends SimpleCriterionTrigger<KillBlackBoolTrigger.TriggerInstance> {
    static final ResourceLocation ID = new ResourceLocation(Eschatology.MODID, "kill_black_bool");
