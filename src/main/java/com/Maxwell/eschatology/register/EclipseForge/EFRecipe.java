...
public class EFRecipe implements Recipe<Container> {
    ...
    public EFRecipe(ResourceLocation id, ItemStack leftInput, ItemStack rightInput, ItemStack output, int processTime) {
        this.id = id;
