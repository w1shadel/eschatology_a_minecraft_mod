...
public class EclipseForgeJEIPlugin implements IModPlugin {
    public static final ResourceLocation UID = new ResourceLocation(Eschatology.MODID, "eclipse_forge_plugin");
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        var recipes = level.getRecipeManager().getAllRecipesFor(EFRecipeType.INSTANCE);
