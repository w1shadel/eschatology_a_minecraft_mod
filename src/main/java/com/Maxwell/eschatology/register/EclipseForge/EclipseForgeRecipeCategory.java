package com.Maxwell.eschatology.register.EclipseForge;
...
public class EclipseForgeRecipeCategory implements IRecipeCategory<EFRecipe> {
    ...
    public static final RecipeType<EFRecipe> RECIPE_TYPE = new RecipeType<>(UID, EFRecipe.class);
    private final IDrawable background;
    private final IDrawable icon;

    public EclipseForgeRecipeCategory(IGuiHelper guiHelper) {
    ...
    public void draw(EFRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(font, timeText, x, y, 0x808080, false);
    }
}